...
const Register = () => {
    ...
    return (
      ...
      <h2 className="font-semibold text-2xl text-center my-4">Register Your Account</h2>
        <form onSubmit={handleRegister} className="card-body">
          ...
          <fieldset className="fieldset">
            ...
            <p className="py-4 font-semibold text-center">Already Have An Account?  <Link to="/auth/login" className="text-secondary">Login</Link></p>
          </fieldset>
        </form>
      </div>
    </div>
